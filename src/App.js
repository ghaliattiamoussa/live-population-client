    ...
    <div style={{ background: 'linear-gradient(135deg, #0f172a, #1e1b4b)', minHeight: '100vh', padding: '20px' }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <input
          ...
          style={{ width: '100%', padding: '15px', borderRadius: '15px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: 'white', marginBottom: '30px', fontSize: '16px' }}
        />

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '15px' }}>
          {sortedCountries.map((country) => (
            <div key={country.code} style={{ background: 'rgba(255,255,255,0.05)', borderRadius: '15px', padding: '15px', border: '1px solid rgba(255,255,255,0.1)' }}>
